...
for i in range(len(filepath)):
    ...
    result2 = list(set(dt_index[0:n]).union(set(gbdt_index[0:n])))
    union = list(set(result2).union(set(rfc_index[0:n])))
    union.sort()

    feature_len = len(union)
